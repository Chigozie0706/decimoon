...
async function main() {
  ...
  console.log("─────────────────────────────────────────");
  console.log("  Deploying DecimoonV1");
  console.log("─────────────────────────────────────────");
  ...
  const DecimoonV1 = await ethers.getContractFactory("DecimoonV1");

  // Deploys:
  //   1. DecimoonV1 implementation contract
  //   2. ERC1967Proxy
