...
-      __gap reserves slots for future V1 storage additions.
  ...
  using SafeERC20 for IERC20;
      ...
      event InvoiceDisputed(uint256 indexed id, address indexed by, string reason);
      event DisputeResolved(uint256 indexed id);
      event InvoiceMarkedOverdue(uint256 indexed id);
      event RecurringRenewed(uint256 indexed id, uint256 newDueDate, uint256 totalCollected);
      ...
      function createInvoice(
          ...
          id = _nextId++;
          InvoiceType iType = isRecurring ? InvoiceType.Recurring : InvoiceType.Standard;
          ...
          emit InvoiceCreated(
              ...
              token, amount, dueDate, iType, interval
          );
      }
